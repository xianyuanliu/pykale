...
class BaseAdaptTrainerVideo(BaseAdaptTrainer):
    ...
    def test_epoch_end(self, outputs):
        ...
        # Uncomment to save output to json file for EPIC UDA 2021 challenge. (3/6)
    ...
    def forward(self, x):
        if self.feat is not None:
            ...
            if self.rgb and self.flow and self.audio:
                ...
                x_a = self.tem_agg1(x_ra)
                x_b = self.tem_agg2(x_af)
...
class DANNTrainerVideo(BaseAdaptTrainerVideo, DANNTrainer):
    ...
    def compute_loss(self, batch, split_name="V"):
        ...
        # # Uncomment to store output for EPIC UDA 2021 challenge. (2/6)
        # if split_name == "test":
...
class CDANTrainerVideo(BaseAdaptTrainerVideo, CDANTrainer):
    ...
    def __init__(
        ...
        **base_params,
        ...
        # self.domain_noun_input_size = 128*300
    ...
    def forward(self, x):
        if self.feat is not None:
            ...
            return (
                ...
                class_output,
                # [adversarial_output_rgb, adversarial_output_flow, adversarial_output_audio],
                [adversarial_output_rgb_verb, adversarial_output_flow_verb, adversarial_output_audio_verb],
            )
