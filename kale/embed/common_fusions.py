...
This file is inherited from https://github.com/pliang279/MultiBench/blob/main/fusions/common_fusions.py.
"""
...
class FiLM(nn.Module):
    ...
    def __init__(
        self,
        gamma_generation_network,
        beta_generation_network,
        base_modal=0,
        gamma_generate_modal=1,
        beta_generate_modal=1,
    ):
...
class MultiplicativeInteractions3Modal(nn.Module):
    ...
    def __init__(self, input_dims, output_dim, task=None):
        ...
        self.a = MultiplicativeInteractions2Modal(
            [input_dims[0], input_dims[1]], [input_dims[2], output_dim], "matrix3D"
        )
