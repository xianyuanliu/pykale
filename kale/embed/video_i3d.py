...
class InceptionI3d(nn.Module):
    ...
    def forward(self, x):
        ...
        # x = self._modules["Conv3d_1a_7x7"](x)  # out: [2, 64, 16, 112, 112]
        # x = self._modules["MaxPool3d_2a_3x3"](x)  # [2, 64, 16, 56, 56]
        # x = self._modules["Conv3d_2b_1x1"](x)  # [2, 64, 8, 56, 56]
        # x = self._modules["Conv3d_2c_3x3"](x)  # [2, 192, 8, 56, 56]
        # x = self._modules["MaxPool3d_3a_3x3"](x)  # [2, 192, 8, 28, 28]
        # x = self._modules["Mixed_3b"](x)  # [2, 256, 4, 28, 28]
        # x = self._modules["Mixed_3c"](x)  # [2, 480, 4, 28, 28]
        # x = self._modules["MaxPool3d_4a_3x3"](x)  # [2, 480, 2, 14, 14]
        # x = self._modules["Mixed_4b"](x)  # [2, 512, 2, 14, 14]
        # x = self._modules["Mixed_4c"](x)  # [2, 512, 2, 14, 14]
        # x = self._modules["Mixed_4d"](x)  # [2, 512, 2, 14, 14]
        # x = self._modules["Mixed_4e"](x)  # [2, 528, 2, 14, 14]
        # x = self._modules["Mixed_4f"](x)  # [2, 832, 2, 14, 14]
