...
_C.DATASET.INPUT_TYPE = "feature"  # type options=["image", "feature"]
...
_C.SOLVER.PRETRAIN_SOURCE = False
# _C.SOLVER.VERBOSE = True
_C.SOLVER.DANN_WARMUP = True

# Learning configs
_C.SOLVER.LOSS_TYPE = "nll"
# _C.SOLVER.LR = 0.003
_C.SOLVER.LR_DECAY = 10
_C.SOLVER.LR_ADAPTIVE = None  # choices = [None, loss, dann]
_C.SOLVER.LR_STEPS = [10, 20]
# _C.SOLVER.MOMENTUM = 0.9
# _C.SOLVER.BATCH_SIZE = [
#     _C.SOLVER.TRAIN_BATCH_SIZE,
#     int(_C.SOLVER.TRAIN_BATCH_SIZE * _C.DATASET.NUM_TARGET / _C.DATASET.NUM_SOURCE),
#     _C.SOLVER.TRAIN_BATCH_SIZE,
# ]
# _C.SOLVER.OPTIMIZER_NAME = "SGD"  # choices = [SGD, Adam]
_C.SOLVER.CLIP_GRADIENT = 20

_C.SOLVER.PRETRAINED = None
_C.SOLVER.RESUME = ""
_C.SOLVER.RESUME_HP = ""
...
_C.SOLVER.PF = 50
_C.SOLVER.SF = 50
_C.SOLVER.COPY_LIST = ["N", "N"]
_C.SOLVER.SAVE_MODEL = True
