...
_C.SOLVER.WEIGHT_DECAY = 1e-3  # 1e-4
_C.SOLVER.NESTEROV = True

_C.SOLVER.TYPE = "SGD"
_C.SOLVER.MAX_EPOCHS = 30  # "nb_adapt_epochs": 100,
# _C.SOLVER.WARMUP = True
_C.SOLVER.MIN_EPOCHS = 10  # "nb_init_epochs": 20,
...
_C.OUTPUT.OUT_DIR = os.path.join("logs", _C.DATASET.SOURCE + "2" + _C.DATASET.TARGET)
...
_C.COMET.PROJECT_NAME = "ActionRecog DomainAdapt"
